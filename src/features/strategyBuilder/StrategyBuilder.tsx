...
import type {
  OptionType, LegSide, LegKind, ViewMode, ValueMode, ReviewLevel,
  MarketView, MarketPreset, StrategyLeg, StrategyTemplate, OptionContract,
  DeribitBookSummary, ReviewItem, RankedTemplate, AxisDragState,
} from './types';
import {
  AXIS_MAX_TICKS, AXIS_MIN_TICK_GAP, MARKETS, EXPIRIES, TAG_LABELS, VIEW_LABELS,
  VIEW_TAG_WEIGHTS, TEMPLATES, INPUT_CLS, SELECT_CLS,
