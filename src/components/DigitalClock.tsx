...
const DigitalClock = React.memo(() => {
  ...
  return (
    <div className="flex items-center justify-center px-2 h-[36px] bg-white/10 hover:bg-white/15 transition-colors duration-[120ms] ease-[cubic-bezier(0.22,1,0.36,1)] rounded-[8px] text-slate-200">
