...
const DigitalClock = () => {
  ...
  return (
    <div className="flex items-center justify-center px-2 h-[36px] bg-white/5 hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all duration-[120ms] ease-[cubic-bezier(0.22,1,0.36,1)] rounded-[8px] text-slate-200">
      {(() => {
      ...
      <header className="h-[44px] flex items-center px-2 glass-bar glass-bar-shadow shrink-0 relative z-[150]" style={{ background: 'var(--base-strong)' }}>
        ...
        <div className="flex items-center gap-2 ml-8 shrink-0">
          <div className="flex items-center gap-2">
            <DigitalClock />
            <div className="hidden md:flex items-center gap-2 rounded-[12px] bg-white/5 px-3 py-2 ring-1 ring-inset ring-border-subtle/70 hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all duration-[120ms] ease-[cubic-bezier(0.22,1,0.36,1)]">
