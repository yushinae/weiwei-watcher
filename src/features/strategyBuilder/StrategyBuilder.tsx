...
const AXIS_MAX_TICKS = 21;
const AXIS_MIN_TICK_GAP = 72;
...
const SMALL_BUTTON_BASE = 'rounded-[6px] bg-[#2B2D35] text-white/62 transition-colors hover:bg-[#3A3B40] hover:text-white/86';
const SMALL_BUTTON_ACTIVE = 'bg-[#3A3F40] text-[#ff9c2e]';
const SMALL_BUTTON_DISABLED = 'cursor-not-allowed bg-[#17181E] text-white/28';
...
function payoffAt(leg: StrategyLeg, S: number, remainingDays: number, baseIv: number, mode: ValueMode, scenarioIvMultiplier = 1) {
...
function nearestStrikeIndex(strikes: number[], value: number) {
...
function pickAxisStrikes(strikes: number[], spot: number, legs: StrategyLeg[], maxTicks = AXIS_MAX_TICKS) {
...
function axisPositionPct(strikes: number[], strike: number | undefined) {
...
function buildAxisLegLayout(strikes: number[], legs: StrategyLeg[], side: LegSide) {
