  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      >
        ...
        {/* Tabs */}
        <div className="flex h-8 items-center gap-0.5 rounded-[4px] bg-[#2B2D35] p-0.5">
          {MONITOR_TABS.map(t => (
            <button
              key={t.id}
              type="button"
              ...
              className={cn(
                'h-7 min-w-[52px] rounded-[4px] px-3 text-[12px] font-semibold tracking-normal transition-colors duration-[120ms] select-none outline-none active:translate-y-px',
                tab === t.id
